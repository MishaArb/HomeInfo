...
class ServicesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<HomeServicesBloc>(
      create: (_) => getIt()..add(HomeServicesFetchEvent()),
        ...
        builder: (context, state) {
          return Scaffold(
            ...
            body: state is HomeServicesSuccessState
                ? _buildServicesItem(state.services)
                : const SizedBox(),
  ...
  _buildServicesItem(List<HomeServiceEntity> services) {
          ...
          startActionPane: ActionPane(
            ...
            children: [
              SlidableAction(
                  ...
                  () {
                    BlocProvider.of<HomeServicesBloc>(context).add(
                      HomeServicesDeleteEvent(
                          id: services[index].id, context: context),
                    );
                  },
                ),
                ...
                icon: Icons.delete,
                label: AppLocalizations.of(context)!.delete_button_inscription,
              ),
            ],
          ),
          child: ListTile(
